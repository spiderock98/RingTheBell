...
volatile unsigned int32 countFbEncoder = 0, limitValue = 0;
...
void calibSpeed()
{
   if (countFbEncoder <= limitValue) // faster than limitTime
   {
      ++angleRingTheBell;
