...
void khoidong() {
  while (count <= 400) thuan();
  while (count >= 0) dung();
  while (count >= -400) nghich();
  while (count <= 0) dung();
  while (count <= 800) thuan();
  while (count >= 0) dung();
  while (count >= -800) nghich();
  while (count <= 0) dung();
  while (count <= 1200) thuan();
  dung();
}
...
void keochuong() {
  while (count >= 400) dung();
  while (count >= -800) nghich();
  while (count <= -400) dung();
  while (count <= 800) thuanPWM();
}
